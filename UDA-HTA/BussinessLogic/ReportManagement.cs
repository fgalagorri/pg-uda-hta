...
namespace BussinessLogic
{
    public class ReportManagement
    {
        ...
        private TableRow MeasuresSummary(Report report)
        {
            ...
            text256.Text = report.SystolicTotalMax.ToString();
            ...
            text298.Text = report.SystolicTotalMin.ToString();
            ...
            //Sistole minimo total
            text305.Text = report.SystolicTotalMin.ToString();
            ...
            text318.Text = report.DiastolicTotalMin.ToString();
