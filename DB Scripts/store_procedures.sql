...
CREATE PROCEDURE insertReport(OUT id BIGINT, IN begin_date DATETIME, IN end_date DATETIME, 
							  ...
							  IN requester VARCHAR (45), IN day_avg_sys INT, IN night_avg_sys INT, 
							  IN total_avg_sys INT, IN day_max_sys INT, IN night_max_sys INT, 
							  IN day_avg_dias INT, IN night_avg_dias INT, total_avg_dias INT, 
							  IN day_max_dias INT, IN night_max_dias INT, IN idDev INT, 
							  IN devReportId VARCHAR(45), IN idTemporaryData INT, 
							  IN idDailyCarnet BIGINT, IN idPatient BIGINT, IN day_min_sis INT, 
							  IN day_min_dias INT, IN night_min_sis INT, IN night_min_dias INT, 
							  IN tot_avg_hr INT, IN day_avg_hr INT, IN night_avg_hr INT, 
							  IN max_day_hr INT, IN max_night_hr INT, IN min_day_hr INT, 
							  IN min_night_hr INT, IN tot_sd_sis DECIMAL(5,2), 
...
INSERT INTO `report` (`begin_date`, `end_date`, `doctor`, `diagnosis`, `diagnosis_date`, 
					  `requester`, `day_avg_sys`, `night_avg_sys`, `total_avg_sys`, `day_max_sys`, 
...
VALUES (begin_date, end_date, doctor, diagnosis, diagnosis_dt, requester, day_avg_sys, 
		...
		tot_sd_sis, tot_sd_dias, day_sd_sis, day_sd_dias, night_sd_sis, night_sd_dias,
