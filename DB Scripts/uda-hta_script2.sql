...
CREATE  TABLE IF NOT EXISTS `udahta_db`.`DailyCarnet` (
  `idDailyCarnet` INT NOT NULL AUTO_INCREMENT ,
  `technical` VARCHAR(45) NULL ,
  `initial_bp1` INT NULL ,
  `initial_bp2` INT NULL ,
  `initial_bp3` INT NULL ,
...
CREATE  TABLE IF NOT EXISTS `udahta_db`.`TemporaryData` (
  ...
  `dyslipidemia` TINYINT(1) NULL ,
  `diabetic` TINYINT(1) NULL ,
  `known_hypertensive` TINYINT(1) NULL ,
...
CREATE  TABLE IF NOT EXISTS `udahta_db`.`Report` (
  ...
  `DailyCarnet_idDailyCarnet` INT NOT NULL ,
